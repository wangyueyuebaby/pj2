...
class VGG_A_BatchNorm(nn.Module):
    ...
    The convolutional part keeps the same channel sizes and pooling schedule as
    VGG_A. BatchNorm is placed between each convolution/linear layer and ReLU.
    """
...
VGG_BatchNorm = VGG_A_BatchNorm
VGG_Batch_Norm = VGG_A_BatchNorm
